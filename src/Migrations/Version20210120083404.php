 ...
 */
final class Version20210120083404 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE picture (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, country_id INT NOT NULL, city_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, description TINYTEXT DEFAULT NULL, day_of_taking VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, localisation VARCHAR(255) DEFAULT NULL, liked INT NOT NULL, INDEX IDX_16DB4F89F675F31B (author_id), INDEX IDX_16DB4F89F92F3E70 (country_id), INDEX IDX_16DB4F898BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
